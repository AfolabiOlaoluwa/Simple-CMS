...
<tt>Username: Olaoluwa123</tt>
<tt>Password: testpassword</tt>
<tt>Note: When you login, you have the ability to create new users/previlledges for other persons to be able to manage the CMS as admin.</tt>
